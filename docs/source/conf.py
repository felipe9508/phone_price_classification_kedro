...
# phone_price_classificator documentation build
...
from phone_price_classificator import __version__ as release

# -- Project information -----------------------------------------------------

project = "phone_price_classificator"
author = "Kedro"
...
htmlhelp_basename = "phone_price_classificatordoc"
...
latex_documents = [
    (
        master_doc,
        "phone_price_classificator.tex",
        "phone_price_classificator Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "phone_price_classificator",
        "Project phone_price_classificator codebase.",
        "Data-Science",
    )
]
